    ...
    <div className="relative min-h-screen overflow-hidden bg-[#f8fdf9] font-sans">
      ...
      >
        ...
        >
          {NAV_LINKS.map((item) => (
            <a
              key={item}
              href="#"
              className="text-[13.5px] text-[#5F5E5A] transition-colors duration-150 hover:text-[#0F6E56]"
            >
              {item}
            </a>
          ))}
        ...
        <div className="flex items-center gap-3">
          <a
            href="/dashboard"
            className="flex items-center gap-1.5 rounded-full border px-4 text-[13px] font-medium text-[#0F6E56] transition-all duration-150 hover:bg-white sm:px-[18px] sm:text-[13.5px]"
            style={{
              height: "36px",
          ...
          {/* Burger — mobile only */}
          <button
            className="flex h-9 w-9 items-center justify-center rounded-lg text-[#5F5E5A] transition-colors hover:bg-[rgba(29,158,117,0.08)] md:hidden"
